...
const KRATHONG_VERTICAL_POS_MIN_MOBILE = 45; // ‼️ แก้ไข: ปรับตำแหน่งต่ำสุดสำหรับจอแนวตั้ง
const KRATHONG_VERTICAL_POS_MAX_MOBILE = 80; // ‼️ แก้ไข: ปรับตำแหน่งสูงสุดสำหรับจอแนวตั้ง
